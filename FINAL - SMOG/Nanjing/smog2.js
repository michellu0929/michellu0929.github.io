...
$(document).ready(function() {
	...
	$.ajax({
		url: 'http://www.pm25.in/api/querys/pm2_5.json?city=nanjing&token=SAspVoyc1n1kczVzrNwH',
		dataType: 'jsonp',
		...
		success: function(data) {
				...
				if (data[9].pm2_5 > 151) {
       			...
       			$('.sub1').html('Leave the Earth')
       			 ...
       			 $('.sub').html('pm2.5: ' + data[9].pm2_5 + '<br>AQI: ' + data[9].aqi); 
 ...
 //        function(data){
 //            $.each(data[9].pm2_5 > 50, function(i, pm2_5){

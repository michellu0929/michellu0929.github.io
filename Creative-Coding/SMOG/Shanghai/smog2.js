...
$(document).ready(function() {
	...
	$.ajax({
		url: 'http://www.pm25.in/api/querys/pm2_5.json?city=shanghai&token=SAspVoyc1n1kczVzrNwH',
		dataType: 'jsonp',
 ...
 //        function(data){
 //            $.each(data[11].pm2_5 > 50, function(i, pm2_5){

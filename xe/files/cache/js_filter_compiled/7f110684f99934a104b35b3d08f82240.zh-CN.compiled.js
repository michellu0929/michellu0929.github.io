function delete_checked_message(form){ return legacy_filter('delete_checked_message', form, 'communication', 'procCommunicationDeleteMessages', filterAlertMessage, [], '确定要删除吗?', {}) };
(function($){

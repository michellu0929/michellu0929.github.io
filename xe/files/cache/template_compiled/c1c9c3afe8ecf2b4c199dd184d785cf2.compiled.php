...
<!--#Meta:layouts/default1/default.layout.css--><?php $__tmp=array('layouts/default1/default.layout.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:common/js/respond.min.js--><?php $__tmp=array('common/js/respond.min.js','','lt IE 9','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:layouts/default1/default.layout.js--><?php $__tmp=array('layouts/default1/default.layout.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<div class="container">
<?php if($__Context->layout_info->BG_IMG){ ?><img src="<?php echo $__Context->layout_info->BG_IMG ?>"><?php } ?>
    <p class="skip"><a href="#content"><?php echo $__Context->lang->skip_to_content ?></a></p>
	<header class="header">
		<h1>
			<a href="<?php echo geturl('') ?>" id="siteTitle">
				<?php if(!Context::getSiteTitle() && !$__Context->layout_info->LOGO_IMG && !$__Context->layout_info->LOGO_TEXT){ ?><img src="/michellu/xe/layouts/default1/siteTitle.png" alt="XpressEngine"><?php } ?>
...
if($__Context->layout_info->LAYOUT_TYPE=='SUB_PAGE'){ ?> class="visual sub"<?php } ?>>
		<div class="list">
			<?php if($__Context->layout_info->LAYOUT_TYPE=='MAIN_PAGE'){ ?><a href="<?php echo geturl('','module','admin','act','dispAdminConfigGeneral') ?>" class="item i1">
				<img src="/michellu/xe/layouts/default1/visual.main.1.jpg" alt="" />
			...
			<?php if($__Context->layout_info->LAYOUT_TYPE=='MAIN_PAGE'){ ?><a href="<?php echo geturl('','module','admin','act','dispMenuAdminSiteMap') ?>" class="item i2">
				<img src="/michellu/xe/layouts/default1/visual.main.2.jpg" alt="" />
			...
			<?php if($__Context->layout_info->LAYOUT_TYPE=='MAIN_PAGE'){ ?><a href="<?php echo geturl('','module','admin','act','dispLayoutAdminInstanceList','layout','default') ?>" class="item i3">
				<img src="/michellu/xe/layouts/default1/visual.main.3.jpg" alt="" />
			...
			<?php if($__Context->layout_info->LAYOUT_TYPE=='SUB_PAGE'){ ?><a href="<?php echo geturl('','module','admin','act','dispLayoutAdminInstanceList','layout','default') ?>" class="item i1">
				<img src="/michellu/xe/layouts/default1/visual.sub.jpg" alt="" />
...
<center><footer class="footer">
	<?php if(!$__Context->layout_info->FOOTER){ ?><p><a href="http://weibo.com/michellu"target="_blank">©michelluSUN</a> all rights received.</p><?php } ?>
